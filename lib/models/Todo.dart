...
class Todo extends amplify_core.Model {
  ...
  const Todo._internal({required this.id, content, owner, required createdAt, required updatedAt}): _content = content, _owner = owner, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Todo({String? id, String? content, String? owner, required amplify_core.TemporalDateTime createdAt, required amplify_core.TemporalDateTime updatedAt}) {
  ...
  Todo copyWith({String? content, String? owner, amplify_core.TemporalDateTime? createdAt, amplify_core.TemporalDateTime? updatedAt}) {
    return Todo._internal(
      id: id,
